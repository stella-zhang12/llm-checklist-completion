...
**Diagnosis**
- `pne_d`: Did the provider correctly diagnose pneumonia?
...
- `pne_referral`: Did the provider make a referral?
...
- `pne_con_p_1`: Explain conditions that required emergency management
